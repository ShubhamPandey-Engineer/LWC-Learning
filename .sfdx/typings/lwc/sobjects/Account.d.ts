...
declare module "@salesforce/schema/Account.Age__c" {
  const Age__c:boolean;
  export default Age__c;
}
declare module "@salesforce/schema/Account.Has_To_Create_Contacts__c" {
  const Has_To_Create_Contacts__c:boolean;
  export default Has_To_Create_Contacts__c;
}
declare module "@salesforce/schema/Account.NumberOfContacts__c" {
  const NumberOfContacts__c:number;
  export default NumberOfContacts__c;
}
...
declare module "@salesforce/schema/Account.Only_Default_Contact__c" {
  const Only_Default_Contact__c:boolean;
  export default Only_Default_Contact__c;
}
