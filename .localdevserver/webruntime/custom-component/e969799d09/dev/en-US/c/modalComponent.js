Webruntime.define('lwc/modalComponent', ['lwc', 'lightning/configProvider', 'Lightning/Modal'], function (lwc, configProvider, LightningModal) { 'use strict';
    ...
    **/
    ...
    class ModalComponent extends lwc.LightningElement {
      handleClick() {
        const result = LightningModal.open({
          size: 'large',
