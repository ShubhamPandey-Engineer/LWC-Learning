Webruntime.define('lwc/createRecordController', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    function tmpl($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("button", {
        key: 0,
        on: {
          "change": _m0 || ($ctx._m0 = api_bind($cmp.createRecord))
        }
      }, [api_text("toadt")])];
    }
    ...
    **/
    ...
    var ACCOUNT_NUMBER = {"fieldApiName":"AccountNumber","objectApiName":"Account"};

    var WEBSITE_FIELD = {"fieldApiName":"Website","objectApiName":"Account"};

    class CreateRecordController extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.objectFields = [NAME_FIELD, WEBSITE_FIELD, ACCOUNT_NUMBER];
      }
    ...
    lwc.registerDecorators(CreateRecordController, {
      fields: ["objectFields"]
    });

    var createRecordController = lwc.registerComponent(CreateRecordController, {
      tmpl: _tmpl
    });
