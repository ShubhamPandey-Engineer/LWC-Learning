Webruntime.define('lwc/reactivityInLWC', ['lwc'], function (lwc) { 'use strict';
   ...
   function tmpl($api, $cmp, $slotset, $ctx) {
     ...
     return [api_element("button", {
       ...
       key: 1
     }, [api_text("Object Not tracked : "), api_dynamic($cmp.noTrackObj.fgname)]), api_element("h5", {
       key: 2
     }, [api_text("Object  tracked : "), api_dynamic($cmp.trackObj.fname)]), api_dynamic($cmp.trackObj.newrop)];
   }
   ...
   class ReactivityInLWC extends lwc.LightningElement {
     ...
     clickHandler() {
       ...
       this.trackObj.newprop = 'new prop added';
