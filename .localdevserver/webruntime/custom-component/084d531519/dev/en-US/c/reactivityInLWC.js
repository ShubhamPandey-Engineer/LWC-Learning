    ...
    * */
    ...
    function tmpl$l($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("button", {
        ...
        key: 2
      }, [api_text("Object  tracked : "), api_dynamic($cmp.trackObj.fname)]), api_dynamic($cmp.trackObj.newprop), api_custom_element("lightning-input", _lightningInput, {
        props: {
          "label": "Input"
        },
        key: 3
    ...
    class ReactivityInLWC extends lwc.LightningElement {
      ...
      clickHandler() {
        ...
        this.trackObj = _objectSpread$1({}, this.trackObj, {
