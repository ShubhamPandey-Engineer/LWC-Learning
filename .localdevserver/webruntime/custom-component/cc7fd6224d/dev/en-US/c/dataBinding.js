Webruntime.define('lwc/dataBinding', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    * */
    ...
    function tmpl$o($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-layout", _lightningLayout, {
        ...
        key: 0,
        on: {
          "change": _m0 || ($ctx._m0 = api_bind($cmp.performDataBinding))
        }
        ...
        key: 1
      }, [api_dynamic($cmp.data)]), api_dynamic($cmp.data)])])];
    }

    var _tmpl$n = lwc.registerTemplate(tmpl$o);
    tmpl$o.stylesheets = [];
    tmpl$o.stylesheetTokens = {
      hostAttribute: "lwc-dataBinding_dataBinding-host",
      shadowAttribute: "lwc-dataBinding_dataBinding"
    };

    class DataBinding extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.data = void 0;
      }
    ...
    lwc.registerDecorators(DataBinding, {
      fields: ["data"]
    });

    var dataBinding = lwc.registerComponent(DataBinding, {
      tmpl: _tmpl$n
    });
