Webruntime.define('lwc/lwcModal', ['lwc', 'lightning/modalHeader', 'lightning/modalBody', 'lightning/modalFooter', 'lightning/configProvider', 'lightning/modal'], function (lwc, _lightningModalHeader, _lightningModalBody, _lightningModalFooter, configProvider, modal) { 'use strict';
    ...
    **/
    ...
    function tmpl$3($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-modal-header", _lightningModalHeader, {
        ...
        key: 2,
        on: {
          "click": _m0 || ($ctx._m0 = api_bind($cmp.handleOkay))
        }
      }, [])])];
    }
    ...
    class LWCModal extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.content = 'f';
      }
