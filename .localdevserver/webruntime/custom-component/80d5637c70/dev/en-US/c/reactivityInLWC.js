Webruntime.define('lwc/reactivityInLWC', ['lwc'], function (lwc) { 'use strict';
   ...
   class ReactivityInLWC extends lwc.LightningElement {
     ...
     clickHandler() {
       this.noTrackObj.fname = 'name Changed'; // does not re-render the cpm

       this.noTrackObj = _objectSpread({}, this.noTrackObj); //this.trackObj.fname = 'name Changed in track prop'
     }
