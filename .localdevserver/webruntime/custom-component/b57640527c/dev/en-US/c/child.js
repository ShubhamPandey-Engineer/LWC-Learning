Webruntime.define('lwc/child', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    **/
    ...
    function tmpl$3($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        key: 0
      }, [api_text("From parent:"), api_dynamic($cmp.childProperty)]), api_custom_element("lightning-button", _lightningButton, {
        props: {
          "variant": "brand",
        ...
        key: 1,
        on: {
          "click": _m0 || ($ctx._m0 = api_bind($cmp.childToParent))
        }
      }, [])];
    }
    ...
    tmpl$3.stylesheetTokens = {
      hostAttribute: "lwc-child_child-host",
      shadowAttribute: "lwc-child_child"
    };

    class Child extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.childProperty = void 0;
      }

      //create custom event in child
      childToParent(event) {
        //create e event
        const messfromChild = new CustomEvent('childevent', {
          detail: 'Message  from child component'
        });
        console.log(event); //dispatch the event
    ...
    var child = lwc.registerComponent(Child, {
      tmpl: _tmpl$4
    });
