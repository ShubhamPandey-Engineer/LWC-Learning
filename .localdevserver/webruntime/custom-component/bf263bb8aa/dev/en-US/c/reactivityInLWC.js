Webruntime.define('lwc/reactivityInLWC', ['lwc'], function (lwc) { 'use strict';
   ...
   class ReactivityInLWC extends lwc.LightningElement {
     ...
     clickHandler() {
       ...
       this.trackObj.fname = 'name Changed in track property'; //this.trackObj.newprop = 'new property added' // does not re-render the component since the existing object is not modified.
       //To rerender your component when adding a new property, assign the object to a new object with both values(new & old).
       // this.trackObj = { ...this.trackObj, newprop: 'new prop added along with existing properties' }  // re-render the cmp
     }
