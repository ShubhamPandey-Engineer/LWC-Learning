Webruntime.define('lwc/conditionalStatement', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    * */
    ...
    function tmpl$l($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("h4", {
        key: 0
      }, [api_text("conditional rendering")]), $cmp.isTrue ? api_element("div", {
        classMap: {},
        key: 2
      }, [api_element("h4", {
        classMap: {},
        ...
        classMap: {},
        key: 3
      }, [api_text("sync not enabled")])]) : null, api_custom_element("lightning-input", _lightningInput, {
        props: {
          "label": "Enable sync:",
          "type": "checkbox"
        },
