Webruntime.define('lwc/reactivityInLWC', ['lwc'], function (lwc) { 'use strict';
   ...
   function tmpl($api, $cmp, $slotset, $ctx) {
     ...
     return [api_element("button", {
       ...
       key: 1
     }, [api_text("Object Not tracked : "), api_dynamic($cmp.noTrackObj.fname)])];
   }
   ...
   class ReactivityInLWC extends lwc.LightningElement {
     ...
     clickHandler() {
       ...
       this.noTrackObj = {
         fname: 'name changed again'
       }; // re-render the component . Since new object is created here and then assigned to trackObj.
